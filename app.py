...
Sleep_hours = st.number_input("", min_value=0, max_value=24, value=7)

st.markdown("### Social Hours per Day")
Social_hours = st.number_input("", min_value=0, max_value=24, value=2)

st.markdown("### Physical Activity Hours per Day")
Physical_activity_hours = st.number_input("", min_value=0, max_value=24, value=1)
